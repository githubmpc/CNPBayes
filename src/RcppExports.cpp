...
// update_multinomialPrFam
Rcpp::NumericMatrix update_multinomialPrFam(Rcpp::S4 xmod);
RcppExport SEXP _CNPBayes_update_multinomialPrFam(SEXP xmodSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::S4 >::type xmod(xmodSEXP);
    rcpp_result_gen = Rcpp::wrap(update_multinomialPrFam(xmod));
    return rcpp_result_gen;
END_RCPP
}
// update_mu2
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_CNPBayes_update_multinomialPrFam", (DL_FUNC) &_CNPBayes_update_multinomialPrFam, 1},
